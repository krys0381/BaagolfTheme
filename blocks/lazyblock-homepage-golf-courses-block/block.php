  ...
  <div class="card-group">
    <?php foreach($attributes["course-cards"] as $courseCard): ?>
        <div class="col-lg-4 col-sm-12 col-12 d-flex justify-content-center">
            ...
            <div class="card">
                <img src="<?php echo $courseCard["image"]?>" class="card-img-top" alt="Course picture">
                <div class="card-body">   
                  <h3 class="card-title"><?php echo $courseCard["card-title"]?></h3>
                  <div class="card-text-container d-flex">
                    <img src="<?php echo $courseCard["par-icon"]?>" width="26" height="26" alt="Par icon">
                    <p class="card-text"><?php echo $courseCard["par"]?></p>
                  </div>
                  <div class="card-text-container d-flex">
                    <img src="<?php echo $courseCard["holes-icon"]?>" width="26" height="26" alt="Golf holes icon">
                    <p class="card-text"><?php echo $courseCard["holes"]?></p>
                  </div>
                  <div class="card-text-container d-flex">
                    <img src="<?php echo $courseCard["length-icon"]?>" width="26" height="26" alt="Course lenght icon">
                    <p class="card-text"><?php echo $courseCard["length"]?></p>
                  </div>
                  <div class="card-text-container d-flex ">
                    <img src="<?php echo $courseCard["status-icon"]?>" width="26" height="26" alt="Status icon">
